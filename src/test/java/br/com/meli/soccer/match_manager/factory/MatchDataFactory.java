...
public class MatchDataFactory {
    ...
    public MatchResponse createMatch(ClubResponseDTO homeClub, ClubResponseDTO visitingClub, StadiumResponseDTO stadium, LocalDateTime localDateTime) {
    ...
    private MatchResponse createMatchAtDatabase(ClubResultDTO homeClubResult, ClubResultDTO visitingClubResult, String stadiumId, LocalDateTime dateTime) {
